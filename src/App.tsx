...
import TsbAiAssistant from "./components/common/TsbAiAssistant";
...
const EcosystemRequest = lazy(() => import("./pages/EcosystemRequest"));
...
function App() {
  ...
  const isStoreProductPath =
    path.startsWith("/store/product/") && path.length > "/store/product/".length;

  const hidePublicAssistant =
    isPasswordRecovery ||
    path === "/login" ||
    path === "/register" ||
    path === "/reset-password" ||
  ...
  if (isPasswordRecovery) page = <ResetPassword />;
  ...
  else if (path === "/client") page = <Client />;
  ...
  else if (path === "/store") page = <Store />;
  else if (isStoreProductPath) page = <StoreProduct />;
  else if (path === "/academy") page = <Academy />;
  else if (path === "/business") page = <Business />;
  else if (path === "/innovation") page = <Innovation />;
  else if (path === "/ecosystem-request") page = <EcosystemRequest />;
  ...
  else if (path === "/cookies") page = <Cookies />;
  ...
  return (
    <>
      ...
      {!hidePublicAssistant && <TsbAiAssistant />}
      <CookieBanner />
    </>
  );
}
