create or replace function public.submit_business_inquiry_server(
  p_user_id uuid,
  p_inquiry_type text,
  p_name text,
  p_email text,
...
revoke all on function public.submit_business_inquiry_server(uuid,text,text,text,text,text,text,text,text) from public;
revoke all on function public.submit_business_inquiry_server(uuid,text,text,text,text,text,text,text,text) from anon;
revoke all on function public.submit_business_inquiry_server(uuid,text,text,text,text,text,text,text,text) from authenticated;
grant execute on function public.submit_business_inquiry_server(uuid,text,text,text,text,text,text,text,text) to service_role;;
